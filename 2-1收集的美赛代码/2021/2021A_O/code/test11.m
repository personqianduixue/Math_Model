...
h1 = imagesc(X);
colormap(jet(4))
% labels = {'Trichoderma','Penicillium','Aspergillus','Decomposed'};
labels = {'Decomposed','Trichoderma','Penicillium','Aspergillus'};
lcolorbar(labels, 'FontName', 'Times New Roman');
